...
public class RequestParams {
    ...
    public HttpEntity getEntity() {
        ...
        if (TANGLIU && (fileParams == null || fileParams.isEmpty())) {
     ...
     * @return the tANGLIU
     */
    public boolean isTANGLIU() {
        return TANGLIU;
    }

    /**
     * setter method
     * @param tANGLIU the tANGLIU to set
     */
    public void setTANGLIU(boolean tANGLIU) {
        TANGLIU = tANGLIU;
    }
