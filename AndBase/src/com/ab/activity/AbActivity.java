...
public abstract class AbActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 填入View
		ab_base.addView(mAbTitleBar, new LinearLayout.LayoutParams(
		...
		// 设置ContentView
		setContentView(ab_base, new LinearLayout.LayoutParams(
	...
	public void showProgressDialog(String message) {
		...
		showDialog(AbConstant.DIALOGPROGRESS, null);
	}
