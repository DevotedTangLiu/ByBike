 ...
 * 
 */
public class RoutesListActivityAdapter extends BaseAdapter {

	private static String TAG = "RoutresBookListAdapter";
	private static final boolean D = true;

	private RouteBookListActivity mContext;
	// xml转View对象
	 ...
	 * @param list
	 */
	public RoutesListActivityAdapter(RouteBookListActivity context, List list) {
