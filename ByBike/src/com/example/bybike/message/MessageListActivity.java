...
public class MessageListActivity extends AbActivity {
    ...
    private void initViewPager() {
        ...
        myApplyListView = (AbPullToRefreshView) myApplyListLayout.findViewById(R.id.mPullRefreshView);
        ...
        // 使用自定义的Adapter
        myApplyListAdapter = new MessageListAdapter(MessageListActivity.this, myApplyListData);
        ...
        myApplyList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(MessageListActivity.this, UserPageActivity.class);
                i.putExtra("id", myApplyListData.get(position).getSenderId());
                i.putExtra("beApplyed", "true");
                startActivity(i);
        ...
        myCommentListView = (AbPullToRefreshView) myCommentListLayout.findViewById(R.id.mPullRefreshView);

        myCommentListView.setPullRefreshEnable(false);
        myCommentListView.setLoadMoreEnable(false);

        myCommentList = (ListView) myCommentListLayout.findViewById(R.id.mListView);
        ...
        // 使用自定义的Adapter
        myCommentListAdapter = new MessageListAdapter(MessageListActivity.this, myCommentListData);
        ...
        myCommentList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent();
                MessageBean mb = myCommentListData.get(position);
                if ("activity".equalsIgnoreCase(mb.getCommentType())) {
                    i.setClass(MessageListActivity.this, ExerciseDetailActivity3.class);
                } else if ("marker".equalsIgnoreCase(mb.getCommentType())) {
                    i.setClass(MessageListActivity.this, MarkerDetailActivity.class);
                } else {
                    i.setClass(MessageListActivity.this, RouteDetailActivity.class);
                }
                i.putExtra("id", mb.getFunctionId());
                startActivity(i);
                overridePendingTransition(R.anim.fragment_in, R.anim.fragment_out);
        ...
        myNotifyListView = (AbPullToRefreshView) myNotifyListLayout.findViewById(R.id.mPullRefreshView);

        myNotifyListView.setPullRefreshEnable(false);
        myNotifyListView.setLoadMoreEnable(false);

        myNotifyList = (ListView) myNotifyListLayout.findViewById(R.id.mListView);
        ...
        // 使用自定义的Adapter
        myNotifyListAdapter = new MessageListAdapter(MessageListActivity.this, myNotifyListData);
    ...
    private void showMessages() {
        ...
        messages = messageBeanDao.queryList(null, null, null, null, null, "send_time desc", null);
        if (messages.size() > 0) {
        ...
        for (MessageBean m : messages) {
            ...
            } else if ("3".equals(m.getMessageType())) {
                myNotifyListData.add(m);
            }
        }
