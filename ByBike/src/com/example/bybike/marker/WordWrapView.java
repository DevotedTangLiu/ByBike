...
/*
 * @(#) WordWrapView.java
 * @Author:tangliu(mail) 2015-2-14
 * @Copyright (c) 2002-2015 Travelsky Limited. All rights reserved.
 */
...
public class WordWrapView extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
      ...
      for(int i=0;i<childCount;i++){
        ...
        view.setBackgroundResource(R.drawable.cornorshape);
