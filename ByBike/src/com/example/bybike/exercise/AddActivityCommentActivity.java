...
public class AddActivityCommentActivity extends AbActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		discussAdapter = new ExerciseDiscussListAdapter(
				AddActivityCommentActivity.this, discussValueList);
	...
	public void clickHandler(View view){
		...
		case R.id.goBack:
			...
			AddActivityCommentActivity.this.finish();
			break;
	...
	protected void processResult(String content) {
		...
		try {
			...
			if("0".equals(code)){
				...
				//隐藏输入法
				((InputMethodManager)getSystemService(INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(AddActivityCommentActivity.this.getCurrentFocus().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS); 
				
				ContentValues v1 = new ContentValues();
				v1.put("senderId", SharedPreferencesUtil.getSharedPreferences_s(AddActivityCommentActivity.this, Constant.USERID));
				v1.put("userName", SharedPreferencesUtil.getSharedPreferences_s(AddActivityCommentActivity.this, Constant.USERNICKNAME));
