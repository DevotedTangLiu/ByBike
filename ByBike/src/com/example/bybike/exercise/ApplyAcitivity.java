...
public class ApplyAcitivity extends AbActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				AbDialogUtil.showAlertDialog(ApplyAcitivity.this, 0, "温馨提示",
						"确认要取消报名吗？取消后报名信息将不保存。",
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (realName.equals("")
						&& "true".equalsIgnoreCase(needRealName)) {
					AbDialogUtil.showAlertDialog(ApplyAcitivity.this, 0,
							"温馨提示", "请输入真实姓名", null);
				} else if (phoneNumber.equals("")
						&& "true".equalsIgnoreCase(needPhone)) {
					AbDialogUtil.showAlertDialog(ApplyAcitivity.this, 0,
							"温馨提示", "请输入电话号码", null);
				} else if (cardNumber.equals("")
						&& "true".equalsIgnoreCase(needIdentification)) {
					AbDialogUtil.showAlertDialog(ApplyAcitivity.this, 0,
							"温馨提示", "请输入身份证号", null);
				} else {
					...
					applyForActivity(realName, phoneNumber, cardNumber,
							remarksString, bikeSelfProvide, helmetSelfProvide);
				}
			}
		});
	 ...
	 */
	protected void applyForActivity(String realName, String phoneNumber,
			String cardNumber, String remarksString, boolean bikeSelfProvide,
		...
		mAbHttpUtil.post(urlString, p, new AbStringHttpResponseListener() {
			...
			@Override
			public void onStart() {
				AbDialogUtil.showProgressDialog(ApplyAcitivity.this, 0,
						"正在报名，请稍后...");
			}
			...
			if ("0".equals(code)) {
				...
				AbDialogUtil.showAlertDialog(ApplyAcitivity.this, 0, "温馨提示",
						...
						new AbAlertDialogFragment.AbDialogOnClickListener() {
							...
							public void onPositiveClick() {
								// TODO Auto-generated method stub
								Intent i = new Intent(ApplyAcitivity.this,
										LoginActivity.class);
								startActivity(i);
