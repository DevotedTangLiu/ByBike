...
public class RidingActivity extends AbActivity {
    ...
    public void clickHandler(View v) {
        ...
        case R.id.quitButton:
            ...
            AbDialogUtil.showAlertDialog(RidingActivity.this, 0, "温馨提示", "确认要退出吗？\n退出后行程信息将不再保存。",
    ...
    private class OnItemsChooseClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            case R.id.collectItemsButton1:
                ...
                for (Marker m : markerList) {
                    if ("public".equalsIgnoreCase(m.getExtraInfo().getString("opertingType"))) {
                        m.setVisible(true);
                    }
                }
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (points.size() >= 2) {
                ...
                distanceInMeter += dis;
                String tmpDistance = decimalformat.format(distanceInMeter / 1000);
                ...
                if (totalSecs >= 5) {
                    ...
                    String tmpSpeed = decimalformat.format((distanceInMeter / totalSecs) * 3.6);
                ...
                String tmpCarbon = decimalformat.format(distanceInMeter * 0.2 / 1000);
