...
public class RouteDetailActivity extends AbActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        discussAdapter = new ExerciseDiscussListAdapter(RouteDetailActivity.this, discussValueList);
    ...
    private void initActivity() {
        ...
        likeButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!SharedPreferencesUtil.getSharedPreferences_b(RouteDetailActivity.this, Constant.ISLOGINED)) {
                    ...
                    showDialog("温馨提示", "您还未登陆，或登陆状态过期，请重新登录再试", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            // TODO Auto-generated method stub
                            Intent i = new Intent(RouteDetailActivity.this, LoginActivity.class);
                            startActivity(i);
        ...
        mBaidumap.setOnMarkerClickListener(new OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(final Marker marker) {
                ...
                if ("true".endsWith(showingIcon)) {
                    ...
                    Intent i = new Intent();
                    i.setClass(RouteDetailActivity.this, MarkerDetailActivity.class);
    ...
    private void processResult(String resultString) {
        try {
            ...
            if ("0".equals(code)) {
                ...
                try {
                    carbonReduceText.setText(routeObj.getString("carbonReduction"));
                } catch (Exception e) {
                    carbonReduceText.setText("0.2");
                }

                hour.setText(routeObj.getString("totalTime"));
                ...
                if (!"".equals(userPicUrl)) {
                    mAbImageDownloader.display(userHeadPic, Constant.serverUrl + userPicUrl);
                }
                ...
                for (int i = 0; i < 8; i++) {
                    ...
                    if (imageUrls[i] != null && !"".equals(imageUrls[i])) {
                        ...
                        mAbImageDownloader.display(mPlayImage, Constant.serverUrl + imageUrls[i]);
                    }
                }
                ...
                try {
                    ...
                    for (int i = 0; i < pointsArray.length(); i++) {
                        ...
                        LatLng ll = new LatLng(point.getDouble("lat"), point.getDouble("lng"));
                        points.add(ll);
                    }
                    if (points.size() >= 2) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            case 0:
                ...
                try {
                    ...
                    PublicMethods.setListViewHeightBasedOnChildren(this.discussList);
                } catch (JSONException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
